...
class Target:
    ...
    scheme     =  storedata(None)
    hostname   =  storedata(None)
    path       =  storedata(None)
    params     =  storedata(None)
    query      =  storedata(None)
    fragment   =  storedata(None)
    username   =  storedata(None)
    password   =  storedata(None)
    port       =  storedata(None)
