...
class DataType:
    ...
    def float_and_any(value) -> float|any:
        try:
            ...
            return it as string object.
            
            Int strings does not need to be returned into
            int format because a lot of libraries accepts
            str formatted int objects rather than int format
            objects.
            """
            try:
