    ...
    def global_payload() -> None:
        ...
        if module:
            try:
                ...
                info_print('Unset done, used module default payload. If this is a mistake, do not unset payload while a module is in use, set a new one instead.',type='yellow')
                return
            except:
                return
