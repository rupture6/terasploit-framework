...
class TerasploitModule(Auxiliary):
    ...
    def initialize(self,info_only: bool = False) -> None:
        ...
        register_option ('auxiliary',opt=[
            OptValidate.create('config','yaml',['','yes','yaml config to read']),
            OptBool.create('session',['false','yes','use http request session'])
        ])

    
    def display_result(self,method,result) -> None:
        print_info ('Displaying response returned...')
